...
export const getAllUsersOrders = TryCatch(async (req, res, next) => {
    ...
    res
        .status(200)
        .json(new ApiResponse(200, "Users All Orders Fatched successfully", orders));
});
...
export const newOrder = TryCatch(async (req, res, next) => {
    const { orderItems, discount, shippingCharges, shippingInfo, subtotal, tax, total, user, } = req.body;
    if (!orderItems ||
        !shippingCharges ||
        !shippingInfo ||
        !subtotal ||
